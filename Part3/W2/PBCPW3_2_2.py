...
#py.plot(redlat, redlon, "ro", label="<20%") will also work
py.scatter(redlat, redlon, color="r", label="<20%")
py.scatter(yellowlat, yellowlon, color='y', label="20%~30%")
py.scatter(greenlat, greenlon, color='g', label="30%~40%")
py.scatter(bluelat, bluelon, color='b', label=">=40%")
